...
export default function Navbar() {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <nav className="hidden lg:block bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
      ...
      {/* Mobile Header */}
      <nav className="lg:hidden bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
        <div className="px-4">
          {/* Top Row */}
