  ...
  return (
    <footer className="bg-neo-ink border-t-8 border-neo-ink relative overflow-hidden">
      ...
      <div className="absolute top-10 left-20 rotate-12">
        <Star className="w-8 h-8 sm:w-12 sm:h-12 fill-neo-secondary text-neo-secondary animate-spin-slow" />
      </div>
      <div className="absolute bottom-20 right-32 -rotate-12">
        <Zap className="w-10 h-10 sm:w-16 sm:h-16 fill-neo-accent text-neo-accent animate-bounce-slow" />
      </div>
      <div className="absolute top-32 right-10 rotate-45">
        <Shield className="w-8 h-8 sm:w-12 sm:h-12 fill-neo-muted text-neo-muted" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <motion.div variants={itemVariants} className="md:col-span-1">
            <Card className="p-6 bg-neo-secondary rotate-2" hover={false}>
              ...
              <p className="text-neo-ink font-bold text-sm mb-6 leading-relaxed uppercase tracking-wide">
