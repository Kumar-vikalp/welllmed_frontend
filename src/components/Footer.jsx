        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">WellMed</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <span className="text-purple-400 mr-2 mt-1">1.</span>
                <span className="text-gray-300 text-sm">Search for your medicines</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2 mt-1">2.</span>
                <span className="text-gray-300 text-sm">Add to cart and checkout</span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-2 mt-1">3.</span>
                <span className="text-gray-300 text-sm">Get delivered in 10 minutes</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors text-sm">All Products</Link></li>
              <li><Link to="/products?trending=true" className="text-gray-300 hover:text-white transition-colors text-sm">Trending</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="tel:+911234567890" className="text-gray-300 hover:text-white transition-colors text-sm">+91 123 456 7890</a></li>
              <li><a href="mailto:support@wellmed.com" className="text-gray-300 hover:text-white transition-colors text-sm">support@wellmed.com</a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 text-xs text-gray-400">
                <span className="bg-green-600 text-white px-2 py-1 rounded text-xs">SSL Secure</span>
                <span className="bg-blue-600 text-white px-2 py-1 rounded text-xs">FDA Approved</span>
                <span className="bg-purple-600 text-white px-2 py-1 rounded text-xs">ISO Certified</span>
              </div>
            </div>
          </div>
